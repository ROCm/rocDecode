...
* Chapter 1: [Overview](#chapter-1-overview)
  + 1.1: [Supported codecs](#11-supported-codecs)
* Chapter 2: [rocDecode hardware capabalities](#chapter-2-rocdecode-hardware-capabilities)
* Chapter 3: [Video decoding pipeline](#chapter-3-video-decoding-pipeline)
* Chapter 4: [Using rocDecode API](#chapter-4-using-rocdecode-api)
  + 4.1: [Video parser](#41-video-parser-defined-in-rocparserh)
  + 4.2: [Querying decode capabilities](#42-querying-decode-capabilities-using-rocdecgetdecodercaps-defined-in-rocdecodeh)
  + 4.3: [Creating a decoder](#43-creating-a-decoder-using-rocdeccreatedecoder)
  + 4.4: [Decoding the frame](#44-decoding-the-frame-using-rocdecdecodeframe)
  + 4.5: [Preparing the decoded frame for further processing](#45-preparing-the-decoded-frame-for-further-processing)
  + 4.6: [Querying the decoding status](#46-querying-the-decoding-status)
  + 4.7: [Reconfiguring the decoder](#47-reconfiguring-the-decoder)
  + 4.8: [Destroying the decoder](#48-destroying-the-decoder)
* Chapter 5: [Samples](#chapter-5-samples)
  + 5.1: [Video decode](#51-video-decode)
  + 5.2: [Video decode performance](#52-video-decode-performance)
  + 5.3: [Video decode fork](#53-video-decode-fork)
  + 5.4: [Video decode memory](#54-video-decode-memory)
  + 5.5: [Video decode multiple files](#55-video-decode-multiple-files)
  + 5.6: [Video decode RGB](#56-video-decode-rgb)
...
### 4.3: Creating a Decoder using rocDecCreateDecoder()
...
### 4.4: Decoding the frame using rocDecDecodeFrame()
