...
.. grid:: 2
  ...
  .. grid-item-card:: How-to
    ...
    * `Parse video data using rocDecParseVideoData <https://github.com/ROCm/rocDecode/blob/master/docs/how-to/Create-parser-object-using-rocDecCreateVideoParser.html>`
